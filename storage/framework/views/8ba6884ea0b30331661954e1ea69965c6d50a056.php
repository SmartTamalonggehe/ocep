          ...
          <div class="col-lg-12 col-12">
              <!-- Basic Forms -->
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <form  action="<?php echo e(route('waropen.update', $waropen->id)); ?>" enctype="multipart/form-data" method="post">
                      <?php echo csrf_field(); ?>
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" value="<?php echo e($waropen->bhs_waropen); ?>" name="bhs_waropen" id="bhs_waropen" class="form-control" required data-validation-required-message="This field is required">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="file" value="<?php echo e($waropen->audio); ?>" name="audio" id="audio" class="form-control" required>
                        </div>
                    </div>
                </div>
                      <!-- /.box-body -->
