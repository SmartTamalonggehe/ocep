        ...
        <div class="multinav">
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="<?php echo e(route('indonesia.index')); ?>">
                            <i class="icon-Layout-4-blocks"><span class="path1"></span><span
                                    class="path2"></span></i>
                    ...
                    <li>
                        <a href="<?php echo e(route('waropen.index')); ?>">
                            <i class="icon-Layout-4-blocks"><span class="path1"></span><span
                                    class="path2"></span></i>
                    ...
                    <li>
                        <a href="<?php echo e(route('indo_warop.index')); ?>">
                            <i class="icon-Layout-4-blocks"><span class="path1"></span><span
                                    class="path2"></span></i>
...
<?php /**PATH /media/smartspartacus/Assets/Projects/Laravel8/Kamus_Waropen/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>