...
<?php $__env->startSection('css'); ?>
    <script src="<?php echo e(mix('css/app.css')); ?>"></script>
                ...
                <div class="row">
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form action="<?php echo e(route('indo_warop.store')); ?>" enctype="multipart/form-data" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="box-body">
                                                ...
                                                <div class="controls">
                                                    <select name="indonesia_id" id="indonesia_id"
                                                        ...
                                                        <?php $__currentLoopData = $indonesia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($indo->id); ?>"><?php echo e($indo->bhs_indonesia); ?>
                                                ...
                                                <div class="controls">
                                                    <select name="waropen_id" id="waropen_id"
                                                        ...
                                                        <?php $__currentLoopData = $waropen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($warop->id); ?>"><?php echo e($warop->bhs_waropen); ?>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $kamus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($loop->iteration); ?></td>
                                                <td><?php echo e($item->indonesia->bhs_indonesia); ?></td>
                                                <td><?php echo e($item->waropen->bhs_waropen); ?></td>
                                                <td align="center">
                                                    <a href="<?php echo e(route('indo_warop.edit', $item->id)); ?>"><button
                                                            type="submit" class="btn btn-success">Edit</button></a>
                                                    <a href="<?php echo e(route('indo_warop.destroy', $item->id)); ?>"
