                  ...
                  <div class="box">
                    ...
                    <form  action="<?php echo e(route('indonesia.store')); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="controls">
                              <input type="text" name="bhs_indonesia" id="bhs_indonesia" class="form-control" required data-validation-required-message="This field is required">
                            </div>
                     ...
                     <table id="example1" class="table table-bordered table-striped">
                       ...
                       <tbody>
                           ...
                           <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo e(route('indonesia.edit', $item->id)); ?>"><button type="submit" class="btn btn-success">Edit</button></a>
                                    <a href="<?php echo e(route('indonesia.destroy', $item->id)); ?>" class="btn btn-danger btn-hapus ">Hapus</a>
