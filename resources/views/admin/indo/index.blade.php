                     ...
                     <table id="example1" class="table table-bordered table-striped">
                       ...
                       <tbody>
                           ...
                           <tr>
                                ...
                                <td align="center">
                                    <a href="{{route('indonesia.edit', $item->id)}}"><button type="submit" class="btn btn-success">Edit</button></a>
                                    <a href="{{route('indonesia.destroy', $item->id)}}" class="btn btn-danger btn-hapus ">Hapus</a>
